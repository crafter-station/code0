...
const initialMultiProviderState: MultiProviderResearchActionState = {
	input: {
		query: "",
		depth: "comprehensive",
		enabledProviders: ["openai", "anthropic", "google", "xai"],
	},
	output: { success: false },
};
...
export default function ResearchPage() {
	...
	const [multiProviderState, multiProviderAction, isMultiProviderPending] =
		useActionState(startMultiProviderResearchAction, initialMultiProviderState);
	const [activeTab, setActiveTab] = useState<"deep" | "quick" | "ultra">(
		"ultra",
	);
			...
			<div className="container mx-auto space-y-8 py-8">
				<div className="space-y-4 text-center">
					...
					<div className="flex justify-center">
						<Link
							href="/providers/live"
							className="inline-flex items-center gap-2 px-4 py-2 font-medium text-blue-600 text-sm transition-colors hover:text-blue-800"
						>
				...
				{activeTab === "ultra" && (
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Revolutionary multi-provider research that leverages 4 leading
								AI models (OpenAI, Anthropic, Google, xAI) working in parallel
								to provide comprehensive analysis from multiple perspectives.
						...
						<CardContent>
							<form action={multiProviderAction} className="space-y-6">
								...
								<div className="space-y-3">
									<Label>
										AI Providers (All Selected for Maximum Coverage)
									</Label>
									<div className="grid grid-cols-2 gap-3">
										{[
											...
											<div
												key={provider.id}
												className="flex items-center space-x-2 rounded-lg border bg-muted/50 p-3"
											>
												<input
													type="checkbox"
													name="providers"
								...
								{!multiProviderState.output.success &&
								...
								{multiProviderState.output.success &&
									multiProviderState.output.data && (
										<div className="space-y-2">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								...
								reflection, and detailed reporting. This process can take
						...
						<CardContent className="space-y-3">
							...
							<div className="flex items-start space-x-3">
								...
								<div>
									...
									<p className="text-gray-600 text-sm dark:text-gray-400">
										Executes multiple targeted searches and gathers
							...
							<div className="flex items-start space-x-3">
								...
								<div>
									...
									<p className="text-gray-600 text-sm dark:text-gray-400">
										Generates comprehensive reports with analysis and
										conclusions
									</p>
								</div>
							</div>
					...
					<Card>
						...
						<CardContent className="space-y-3">
							...
							<div className="flex items-center space-x-2">
								<div className="h-2 w-2 rounded-full bg-green-500" />
								<span className="text-sm">
									Structured reporting with sources
								</span>
							</div>
							<div className="flex items-center space-x-2">
								<div className="h-2 w-2 rounded-full bg-green-500" />
